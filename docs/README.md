...
Este arquivo funciona como indice da documentacao do projeto e foi organizado para facilitar navegacao tanto no Git quanto no Obsidian.

## Links Markdown

- [README principal](../README.md)
- [Fase 1 - Requisitos](fase-01-requisitos.md)
- [Fase 2 - Arquitetura](fase-02-arquitetura.md)
...
- [Fase 4 - Turmas e vagas](fase-04-turmas-vagas.md)
...
Conforme o projeto evoluir, novas fases, ADRs, guias operacionais e runbooks serao adicionados aqui para manter a documentacao facil de navegar e de manter.
